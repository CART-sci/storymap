...
static_plot <- ggplot(plot_data, aes(x = x, y = y)) +
  geom_line(aes(color = id, linetype = period), show.legend = F) +
  labs(x = "Year",
...
annotate(geom = "text", x = 1994, y = 29, label = "Aquaculture", 
         cex = 5.5, angle = 22, fontface = "bold", color = "#F8766D") +
annotate(geom = "text", x = 1994, y = 70, label = "Wild Capture", 
         cex = 5.5, fontface = "bold", color = "#00BFC4")
